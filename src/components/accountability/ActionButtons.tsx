    ...
    <>
      ...
      <div className="mt-6 rounded-2xl border border-border bg-card p-5 md:p-6">
        <div className="flex items-center gap-2 font-heading text-[0.65rem] uppercase tracking-widest text-accent-dark">
          ...
          Reflection dates · Add to calendar
        </div>
        <p className="mt-2 text-sm text-muted-foreground">
          Three calendar events, one per reflection date. Open each link to
        ...
        <div className="mt-4 grid gap-3 md:grid-cols-2">
          <div>
            ...
            <ul className="mt-2 space-y-2 text-xs">
              <CalendarLink href={googleCalendarUrls.r1} label="+ Add first reflection" />
              <CalendarLink href={googleCalendarUrls.r2} label="+ Add second reflection" />
              <CalendarLink href={googleCalendarUrls.r3} label="+ Add third reflection" />
            </ul>
          </div>
          <div>
            <p className="font-heading text-[0.65rem] uppercase tracking-widest text-foreground">
            ...
            <ul className="mt-2 space-y-2 text-xs">
              <CalendarLink href={outlookCalendarUrls.r1} label="+ Add first reflection" />
              <CalendarLink href={outlookCalendarUrls.r2} label="+ Add second reflection" />
              <CalendarLink href={outlookCalendarUrls.r3} label="+ Add third reflection" />
            </ul>
          </div>
        </div>
      </div>
